...
12. `12-oreiller-vague/oreiller-vague_rose-blanc_34_10.jpg` → Contour 01, Rose Blanc → sky packshot, 1:1 → cleanup: remove every award badge, medal, ribbon and text overlay; keep only the pillow. → `somnila_contour-01_sky-rose-blanc_1x1_v3.jpg`
...
36. `09-oreiller-cervical/oreiller-cervical_blanc_34_51.jpg` → Family Set (3 × Neck 01), Cloud → three copies in a shallow diagonal line, 1:1 → cleanup: (three identical copies in a shallow diagonal line) → `somnila_family-set_sky-cloud_1x1_v3.jpg`
